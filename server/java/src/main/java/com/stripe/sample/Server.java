...
public class Server {
    ...
    public static void main(String[] args) {
        ...
        // Serve static order completion page
        get("/complete", (request, response) -> {
            response.redirect("/complete.html?payment_intent=" + request.queryParams("payment_intent"));
            return "";
        });

        // Fetch PaymentIntent JSON to display in the order page
        get("/payment-intent", (request, response) -> {
        ...
        post("/create-payment-intent", (request, response) -> {
            ...
            PaymentIntentCreateParams createParams = new PaymentIntentCreateParams.Builder()
                    ...
                    .addPaymentMethodType("card").addPaymentMethodType("ideal").build();
            // Create a PaymentIntent with the order amount and currency and payment method
            // types
            PaymentIntent intent = PaymentIntent.create(createParams);
            // Send publishable key and PaymentIntent details to client
            return gson
                    .toJson(new CreatePaymentResponse(dotenv.get("STRIPE_PUBLISHABLE_KEY"), intent.getClientSecret()));
        });
